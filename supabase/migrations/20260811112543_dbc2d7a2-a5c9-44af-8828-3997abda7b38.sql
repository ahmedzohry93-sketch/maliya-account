...
REVOKE EXECUTE ON FUNCTION public.advance_recurring_due(uuid) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.advance_recurring_due(uuid) TO authenticated, service_role;