...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.profiles, public.roles, public.permissions, public.role_permissions, public.user_roles, public.accounts, public.journal_entries, public.journal_lines, public.partners, public.audit_logs TO authenticated;
GRANT ALL ON public.profiles, public.roles, public.permissions, public.role_permissions, public.user_roles, public.accounts, public.journal_entries, public.journal_lines, public.partners, public.audit_logs TO service_role;
GRANT USAGE, SELECT ON SEQUENCE public.journal_entry_no_seq TO authenticated, service_role;
